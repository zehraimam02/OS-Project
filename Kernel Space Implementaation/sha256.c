...
static void sha256_transform(struct SHA256_CTX* ctx, const uint8 data[]) {
...
void sha256_final(struct SHA256_CTX* ctx, uint8 hash[]) {
  ...
  ctx->data[63] = (uint8)(ctx->bitlen[0]);
  ctx->data[62] = (uint8)(ctx->bitlen[0] >> 8);
  ctx->data[61] = (uint8)(ctx->bitlen[0] >> 16);
  ctx->data[60] = (uint8)(ctx->bitlen[0] >> 24);
  ctx->data[59] = (uint8)(ctx->bitlen[1]);
  ctx->data[58] = (uint8)(ctx->bitlen[1] >> 8);
  ctx->data[57] = (uint8)(ctx->bitlen[1] >> 16);
  ctx->data[56] = (uint8)(ctx->bitlen[1] >> 24);
